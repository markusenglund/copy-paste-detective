...
export const verdictEnum = pgEnum("verdict", ["true_positive", "false_positive", "ambiguous"]);

export const humanReviews = pgTable("human_reviews", {
  id: serial("id").primaryKey(),
  dryadDatasetId: integer("dryad_dataset_id").notNull().references(() => dryadDatasets.id),
